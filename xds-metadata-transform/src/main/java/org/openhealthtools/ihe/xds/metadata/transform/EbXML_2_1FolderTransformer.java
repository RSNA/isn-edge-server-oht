 ...
 *
 */
public class EbXML_2_1FolderTransformer implements FolderTransformer {
	...
	private void setAssociatedDocuments(FolderType folder) {
		...
		for(int i = 0; i<folder.getAssociatedDocuments().size(); i++){
			...
			this.documentsInFolder[i].setAssociationType(UUIDs.HAS_MEMBER);
