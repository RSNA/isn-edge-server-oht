 ...
 * </p>
 * <ul>
 *   <li>{@link org.openhealthtools.ihe.xds.response.response.impl.FolderResponseTypeImpl#getReference <em>Reference</em>}</li>
 *   <li>{@link org.openhealthtools.ihe.xds.response.response.impl.FolderResponseTypeImpl#getHomeCommunityId <em>Home Community Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FolderResponseTypeImpl extends EObjectImpl implements FolderResponseType {
	/**
	 ...
	 * @ordered
	 */
	protected FolderType reference;
	 ...
	 * @generated
	 */
	public FolderType getReference() {
		return reference;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetReference(FolderType newReference, NotificationChain msgs) {
		FolderType oldReference = reference;
		reference = newReference;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.FOLDER_RESPONSE_TYPE__REFERENCE, oldReference, newReference);
	 ...
	 * @generated
	 */
	public void setReference(FolderType newReference) {
		if (newReference != reference) {
			NotificationChain msgs = null;
			if (reference != null)
				msgs = ((InternalEObject)reference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.FOLDER_RESPONSE_TYPE__REFERENCE, null, msgs);
			if (newReference != null)
				msgs = ((InternalEObject)newReference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.FOLDER_RESPONSE_TYPE__REFERENCE, null, msgs);
			msgs = basicSetReference(newReference, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.FOLDER_RESPONSE_TYPE__REFERENCE, newReference, newReference));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.FOLDER_RESPONSE_TYPE__REFERENCE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ModelPackage.FOLDER_RESPONSE_TYPE__REFERENCE:
				setReference((FolderType)newValue);
				return;
			case ModelPackage.FOLDER_RESPONSE_TYPE__HOME_COMMUNITY_ID:
