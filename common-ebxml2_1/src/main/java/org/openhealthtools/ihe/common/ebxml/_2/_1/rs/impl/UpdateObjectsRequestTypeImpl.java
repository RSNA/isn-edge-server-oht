 ...
 * </copyright>
 *
 * $Id: UpdateObjectsRequestTypeImpl.java,v 1.1 2006/06/27 23:18:01 esmith Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.ihe.common.ebxml._2._1.rs.impl.UpdateObjectsRequestTypeImpl#getLeafRegistryObjectList <em>Leaf Registry Object List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class UpdateObjectsRequestTypeImpl extends EObjectImpl implements UpdateObjectsRequestType {
	/**
	...
	protected EClass eStaticClass() {
		return RegistryPackage.Literals.UPDATE_OBJECTS_REQUEST_TYPE;
	}
	...
	public NotificationChain basicSetLeafRegistryObjectList(LeafRegistryObjectListType newLeafRegistryObjectList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RegistryPackage.UPDATE_OBJECTS_REQUEST_TYPE__LEAF_REGISTRY_OBJECT_LIST, oldLeafRegistryObjectList, newLeafRegistryObjectList);
	...
	public void setLeafRegistryObjectList(LeafRegistryObjectListType newLeafRegistryObjectList) {
		if (newLeafRegistryObjectList != leafRegistryObjectList) {
			...
			if (leafRegistryObjectList != null)
				msgs = ((InternalEObject)leafRegistryObjectList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RegistryPackage.UPDATE_OBJECTS_REQUEST_TYPE__LEAF_REGISTRY_OBJECT_LIST, null, msgs);
			if (newLeafRegistryObjectList != null)
				msgs = ((InternalEObject)newLeafRegistryObjectList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RegistryPackage.UPDATE_OBJECTS_REQUEST_TYPE__LEAF_REGISTRY_OBJECT_LIST, null, msgs);
			msgs = basicSetLeafRegistryObjectList(newLeafRegistryObjectList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RegistryPackage.UPDATE_OBJECTS_REQUEST_TYPE__LEAF_REGISTRY_OBJECT_LIST, newLeafRegistryObjectList, newLeafRegistryObjectList));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RegistryPackage.UPDATE_OBJECTS_REQUEST_TYPE__LEAF_REGISTRY_OBJECT_LIST:
