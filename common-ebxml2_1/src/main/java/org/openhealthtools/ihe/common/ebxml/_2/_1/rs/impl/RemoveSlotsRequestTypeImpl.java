 ...
 * </copyright>
 *
 * $Id: RemoveSlotsRequestTypeImpl.java,v 1.1 2006/06/27 23:18:01 esmith Exp $
 */
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Remove Slots Request Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.openhealthtools.ihe.common.ebxml._2._1.rs.impl.RemoveSlotsRequestTypeImpl#getObjectRef <em>Object Ref</em>}</li>
 *   <li>{@link org.openhealthtools.ihe.common.ebxml._2._1.rs.impl.RemoveSlotsRequestTypeImpl#getSlot <em>Slot</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RemoveSlotsRequestTypeImpl extends EObjectImpl implements RemoveSlotsRequestType {
	 ...
	 * @generated
	 */
	protected RemoveSlotsRequestTypeImpl() {
		super();
	}
	...
	public NotificationChain basicSetObjectRef(ObjectRefType newObjectRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RegistryPackage.REMOVE_SLOTS_REQUEST_TYPE__OBJECT_REF, oldObjectRef, newObjectRef);
	...
	public void setObjectRef(ObjectRefType newObjectRef) {
		if (newObjectRef != objectRef) {
			...
			if (objectRef != null)
				msgs = ((InternalEObject)objectRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RegistryPackage.REMOVE_SLOTS_REQUEST_TYPE__OBJECT_REF, null, msgs);
			if (newObjectRef != null)
				msgs = ((InternalEObject)newObjectRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RegistryPackage.REMOVE_SLOTS_REQUEST_TYPE__OBJECT_REF, null, msgs);
			msgs = basicSetObjectRef(newObjectRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RegistryPackage.REMOVE_SLOTS_REQUEST_TYPE__OBJECT_REF, newObjectRef, newObjectRef));
	}
	...
	public EList getSlot() {
		if (slot == null) {
			slot = new EObjectContainmentEList(SlotType1.class, this, RegistryPackage.REMOVE_SLOTS_REQUEST_TYPE__SLOT);
		}
		return slot;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RegistryPackage.REMOVE_SLOTS_REQUEST_TYPE__OBJECT_REF:
				return basicSetObjectRef(null, msgs);
			case RegistryPackage.REMOVE_SLOTS_REQUEST_TYPE__SLOT:
