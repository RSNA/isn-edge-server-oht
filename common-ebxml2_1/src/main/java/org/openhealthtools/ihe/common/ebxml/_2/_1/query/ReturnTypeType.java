 ...
 * </copyright>
 *
 * $Id: ReturnTypeType.java,v 1.1 2006/06/27 23:18:06 esmith Exp $
 */
 ...
 * <!-- end-user-doc -->
 * @see org.openhealthtools.ihe.common.ebxml._2._1.query.QueryPackage#getReturnTypeType()
 * @model
 * @generated
 */
public final class ReturnTypeType extends AbstractEnumerator {
	 ...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #REGISTRY_ENTRY_LITERAL
	 * @model name="RegistryEntry"
	 * @generated
	 * @ordered
	 */
	public static final int REGISTRY_ENTRY = 2;
	 ...
	 * @ordered
	 */
	public static final int LEAF_CLASS = 3;
	 ...
	 * @ordered
	 */
	public static final int LEAF_CLASS_WITH_REPOSITORY_ITEM = 4;
	 ...
	 * @ordered
	 */
	public static final ReturnTypeType REGISTRY_ENTRY_LITERAL = new ReturnTypeType(REGISTRY_ENTRY, "RegistryEntry", "RegistryEntry");
	...
	public static ReturnTypeType get(int value) {
		switch (value) {
			...
			case REGISTRY_ENTRY: return REGISTRY_ENTRY_LITERAL;
