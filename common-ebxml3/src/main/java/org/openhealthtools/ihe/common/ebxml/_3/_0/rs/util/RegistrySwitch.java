 ...
 * </copyright>
 *
 * $Id: RegistrySwitch.java,v 1.1 2006/10/19 20:16:31 sknoop Exp $
 */
...
public class RegistrySwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RegistryPackage.REGISTRY_REQUEST_TYPE: {
				RegistryRequestType registryRequestType = (RegistryRequestType)theEObject;
				Object result = caseRegistryRequestType(registryRequestType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
