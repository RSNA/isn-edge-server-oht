 ...
 * </copyright>
 *
 * $Id: DeprecateObjectsRequestTypeImpl.java,v 1.1 2006/10/19 20:16:14 sknoop Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.ihe.common.ebxml._3._0.lcm.impl.DeprecateObjectsRequestTypeImpl#getAdhocQuery <em>Adhoc Query</em>}</li>
 *   <li>{@link org.openhealthtools.ihe.common.ebxml._3._0.lcm.impl.DeprecateObjectsRequestTypeImpl#getObjectRefList <em>Object Ref List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DeprecateObjectsRequestTypeImpl extends RegistryRequestTypeImpl implements DeprecateObjectsRequestType {
	/**
	...
	protected EClass eStaticClass() {
		return LCMPackage.Literals.DEPRECATE_OBJECTS_REQUEST_TYPE;
	}
	...
	public NotificationChain basicSetAdhocQuery(AdhocQueryType newAdhocQuery, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LCMPackage.DEPRECATE_OBJECTS_REQUEST_TYPE__ADHOC_QUERY, oldAdhocQuery, newAdhocQuery);
	...
	public void setAdhocQuery(AdhocQueryType newAdhocQuery) {
		if (newAdhocQuery != adhocQuery) {
			...
			if (adhocQuery != null)
				msgs = ((InternalEObject)adhocQuery).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LCMPackage.DEPRECATE_OBJECTS_REQUEST_TYPE__ADHOC_QUERY, null, msgs);
			if (newAdhocQuery != null)
				msgs = ((InternalEObject)newAdhocQuery).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LCMPackage.DEPRECATE_OBJECTS_REQUEST_TYPE__ADHOC_QUERY, null, msgs);
			msgs = basicSetAdhocQuery(newAdhocQuery, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LCMPackage.DEPRECATE_OBJECTS_REQUEST_TYPE__ADHOC_QUERY, newAdhocQuery, newAdhocQuery));
	}
	...
	public NotificationChain basicSetObjectRefList(ObjectRefListType newObjectRefList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LCMPackage.DEPRECATE_OBJECTS_REQUEST_TYPE__OBJECT_REF_LIST, oldObjectRefList, newObjectRefList);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setObjectRefList(ObjectRefListType newObjectRefList) {
		if (newObjectRefList != objectRefList) {
			...
			if (objectRefList != null)
				msgs = ((InternalEObject)objectRefList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LCMPackage.DEPRECATE_OBJECTS_REQUEST_TYPE__OBJECT_REF_LIST, null, msgs);
			if (newObjectRefList != null)
				msgs = ((InternalEObject)newObjectRefList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LCMPackage.DEPRECATE_OBJECTS_REQUEST_TYPE__OBJECT_REF_LIST, null, msgs);
			msgs = basicSetObjectRefList(newObjectRefList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LCMPackage.DEPRECATE_OBJECTS_REQUEST_TYPE__OBJECT_REF_LIST, newObjectRefList, newObjectRefList));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LCMPackage.DEPRECATE_OBJECTS_REQUEST_TYPE__ADHOC_QUERY:
				return basicSetAdhocQuery(null, msgs);
			case LCMPackage.DEPRECATE_OBJECTS_REQUEST_TYPE__OBJECT_REF_LIST:
