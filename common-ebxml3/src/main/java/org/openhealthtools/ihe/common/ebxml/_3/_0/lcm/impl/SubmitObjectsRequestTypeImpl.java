 ...
 * </copyright>
 *
 * $Id: SubmitObjectsRequestTypeImpl.java,v 1.1 2006/10/19 20:16:14 sknoop Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.openhealthtools.ihe.common.ebxml._3._0.lcm.impl.SubmitObjectsRequestTypeImpl#getRegistryObjectList <em>Registry Object List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SubmitObjectsRequestTypeImpl extends RegistryRequestTypeImpl implements SubmitObjectsRequestType {
	/**
	...
	protected EClass eStaticClass() {
		return LCMPackage.Literals.SUBMIT_OBJECTS_REQUEST_TYPE;
	}
	...
	public NotificationChain basicSetRegistryObjectList(RegistryObjectListType newRegistryObjectList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LCMPackage.SUBMIT_OBJECTS_REQUEST_TYPE__REGISTRY_OBJECT_LIST, oldRegistryObjectList, newRegistryObjectList);
	...
	public void setRegistryObjectList(RegistryObjectListType newRegistryObjectList) {
		if (newRegistryObjectList != registryObjectList) {
			...
			if (registryObjectList != null)
				msgs = ((InternalEObject)registryObjectList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LCMPackage.SUBMIT_OBJECTS_REQUEST_TYPE__REGISTRY_OBJECT_LIST, null, msgs);
			if (newRegistryObjectList != null)
				msgs = ((InternalEObject)newRegistryObjectList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LCMPackage.SUBMIT_OBJECTS_REQUEST_TYPE__REGISTRY_OBJECT_LIST, null, msgs);
			msgs = basicSetRegistryObjectList(newRegistryObjectList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LCMPackage.SUBMIT_OBJECTS_REQUEST_TYPE__REGISTRY_OBJECT_LIST, newRegistryObjectList, newRegistryObjectList));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case LCMPackage.SUBMIT_OBJECTS_REQUEST_TYPE__REGISTRY_OBJECT_LIST:
